...
Revision links store full change IDs by default.  Use ~C-u~ with
~org-store-link~ for an immutable commit ID, or ~C-u C-u~ to preserve the
bookmark, tag, or revset at point.
